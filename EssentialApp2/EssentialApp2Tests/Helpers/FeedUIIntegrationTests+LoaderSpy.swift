...
extension FeedUIIntegrationTests {
    ...
    class LoaderSpy {
        ...
        private var feedLoader = EssentialApp2Tests.LoaderSpy<Void, Paginated<FeedImage>>()
        ...
        private var loadMoreLoader = EssentialApp2Tests.LoaderSpy<Void, Paginated<FeedImage>>()
        ...
        private var imageLoader = EssentialApp2Tests.LoaderSpy<URL, Data>()
