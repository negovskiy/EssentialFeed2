...
extension XCTestCase {
    func record(snapshot data: Data, named name: String, file: StaticString = #filePath, line: UInt = #line) {
        ...
        do {
            ...
            XCTFail("Record succeeded - use `assert` to verify", file: file, line: line)
        } catch {
